...
public class MyScanner {
    ...
    private final Predicate<String> integerConstantPredicate;

    private final Predicate<String> characterConstantPredicate;

    private final Predicate<String> stringConstantPredicate;
    ...
    public MyScanner(String tokensFileName, String fileSeparator) {
        ...
        this.identifierPredicate = (String token) -> token.matches("^[a-zA-Z][a-zA-Z0-9]*$");
        this.integerConstantPredicate = (String token) -> token.matches("^0|[+-]?[1-9][0-9]*$");
        this.characterConstantPredicate = (String token) -> token.matches("^'[a-zA-Z0-9+*/%<=> ,:()_.?!-]?'$");
        this.stringConstantPredicate = (String token) -> token.matches("^\"[a-zA-Z0-9+*/%<=> ,:()_.?!-]*\"$");
    ...
    public MyScanner(String tokensFileName, String fileSeparator, String identifiersAutomatonFileName, String integerConstantAutomatonFileName) {
        this.reservedWords = new HashSet<>();
        this.operators = new HashSet<>();
        this.specialOperators = new HashSet<>();
        this.separators = new HashSet<>();
        this.whiteSpaces = new HashSet<>(Set.of(" ", "\t"));
        FiniteAutomaton idFA = new FiniteAutomatonImpl(identifiersAutomatonFileName);
        FiniteAutomaton constIntFA = new FiniteAutomatonImpl(integerConstantAutomatonFileName);
        this.identifierPredicate = idFA::accepts;
        this.integerConstantPredicate = constIntFA::accepts;
        this.characterConstantPredicate = (String token) -> token.matches("^'[a-zA-Z0-9+*/%<=> ,:()_.?!-]?'$");
        this.stringConstantPredicate = (String token) -> token.matches("^\"[a-zA-Z0-9+*/%<=> ,:()_.?!-]*\"$");
        this.identifiersSymbolTable = null;
        this.constantsSymbolTable = null;
    ...
    public MyScanner(String tokensFileName, String fileSeparator, String identifiersAutomatonFileName, String integerConstantAutomatonFileName, String characterConstantAutomatonFileName, String stringConstantAutomatonFileName) {
        this.reservedWords = new HashSet<>();
        this.operators = new HashSet<>();
        this.specialOperators = new HashSet<>();
        this.separators = new HashSet<>();
        ...
        FiniteAutomaton idFA = new FiniteAutomatonImpl(identifiersAutomatonFileName);
        FiniteAutomaton constIntFA = new FiniteAutomatonImpl(integerConstantAutomatonFileName);
        FiniteAutomaton constCharFA = new FiniteAutomatonImpl(characterConstantAutomatonFileName);
        FiniteAutomaton constStringFA = new FiniteAutomatonImpl(stringConstantAutomatonFileName);
        this.identifierPredicate = idFA::accepts;
        this.integerConstantPredicate = constIntFA::accepts;
        this.characterConstantPredicate = constCharFA::accepts;
        this.stringConstantPredicate = constStringFA::accepts;
        this.identifiersSymbolTable = null;
        this.constantsSymbolTable = null;
        this.programInternalForm = null;
        this.isLexicallyCorrect = null;
    ...
    private boolean isIdentifier(String token) {
        return this.identifierPredicate.test(token);
    }

    private boolean isIntegerConstant(String token) {
        return this.integerConstantPredicate.test(token);
    }

    private boolean isCharacterConstant(String token) {
        return this.characterConstantPredicate.test(token);
    }

    private boolean isStringConstant(String token) {
        return this.stringConstantPredicate.test(token);
    }
